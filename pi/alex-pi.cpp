...
void sendCommand(char command)
{
	...
	switch(command)
	{
		...
		case 'p':
		case 'P':
			commandPacket.command = COMMAND_PULSE;
			sendPacket(&commandPacket);
			break;
		...
		default:
			printf("Bad command. WASD for movement SPACE=stop, m=toggle trans, c=clear stats, g=get stats, q=exit, o=servo, p=pulse, l=color sensor\n");
